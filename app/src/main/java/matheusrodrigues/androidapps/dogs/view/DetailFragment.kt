...
import matheusrodrigues.androidapps.dogs.databinding.SendSmsDialogBinding
import matheusrodrigues.androidapps.dogs.model.DogBreed
import matheusrodrigues.androidapps.dogs.model.DogPalette
import matheusrodrigues.androidapps.dogs.model.SmsInfo
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            ...
            R.id.action_share -> {
                ...
                intent.putExtra(Intent.EXTRA_SUBJECT, "Check out this dogbreed")
